                                ...
                                <div>
                                    ...
                                    <div className="form-group">
                                        <label className="form-label" >Age Range</label>                                        
                                            <Range 
                                                min={13} 
                                                max={99} 
                                                defaultValue={[this.props.searchSetting.ageMin, this.props.searchSetting.ageMax]} 
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="radio-group"> 
                                            <div className="radio">
                                                <input id="radio1" name="radio1" type="radio" value="" onChange={this.handleChangeGender.bind(this)} checked={this.state.searchSetting.gender === ''} />
                                                <label htmlFor="radio1" className="radio-label">All</label>
                                            </div>

                                            <div className="radio">
                                                <input id="radio2" name="radio1" type="radio" value="Male" onChange={this.handleChangeGender.bind(this)} checked={this.state.searchSetting.gender === 'Male'} />
                                                <label htmlFor="radio2" className="radio-label">Male</label>
                                            </div>

                                            <div className="radio">
                                                <input id="radio3" name="radio1" type="radio" value="Female" onChange={this.handleChangeGender.bind(this)} checked={this.state.searchSetting.gender === 'Female'} />
